...
func warningEvent(event *calendar.Event, self *calendar.EventAttendee) string {
...
func eventToOrg(event *calendar.Event) (string, error) {
	...
	return fmt.Sprintf("** %s%s [[%s][%s]] %s %s-%s <%s>\n", optionalEvent(self), warningEvent(event, self), event.HtmlLink, event.Summary, roomEvent(event), startTime, endTime, startDate), nil
}
